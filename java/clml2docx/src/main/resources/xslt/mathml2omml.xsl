...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:mml="http://www.w3.org/1998/Math/MathML"
  ...
  <!-- %%Template: match *
	...
	-->
  <xsl:template match="*" mode="mml2omml">
  ...
  <!-- %%Template: mml:mrow | mml:mstyle
         ...
         pass through -->
  <xsl:template match="mml:mrow|mml:mstyle" mode="mml2omml">
  ...
  <xsl:template match="mml:mi[not(child::mml:mglyph)] | 
                       ...
                       mml:mtext[not(child::mml:mglyph)]" mode="mml2omml">
  ...
  <!-- %%Template: match mfrac 
		-->
  <xsl:template match="mml:mfrac" mode="mml2omml">
    ...
    <xsl:element name="m:f">
      ...
      <xsl:element name="m:num">
        ...
        <xsl:apply-templates select="child::*[1]" mode="mml2omml" />
      </xsl:element>
      <xsl:element name="m:den">
        <xsl:call-template name="CreateArgProp" />
        <xsl:apply-templates select="child::*[2]" mode="mml2omml" />
      </xsl:element>
    </xsl:element>
  </xsl:template>
  ...
  <!-- %%Template: match menclose msqrt
	-->
  <xsl:template match="mml:menclose | mml:msqrt" mode="mml2omml">
  ...
  <!-- %%Template: match mroot
	-->
  <xsl:template match="mml:mroot" mode="mml2omml">
    <xsl:element name="m:rad">
      <xsl:element name="m:radPr">
        <xsl:element name="m:degHide">
  ...
  <xsl:template name="MakeLinearFraction">
    ...
    <xsl:element name="m:f">
      ...
      <xsl:element name="m:num">
        <xsl:call-template name="CreateArgProp" />
        <xsl:apply-templates select="$ndCur/*[1]" mode="mml2omml" />
      </xsl:element>
      <xsl:element name="m:den">
        <xsl:call-template name="CreateArgProp" />
        <xsl:apply-templates select="$ndCur/*[3]" mode="mml2omml" />
      </xsl:element>
    </xsl:element>
  </xsl:template>
  ...
  <xsl:template name="WriteFunc">
    ...
    <xsl:element name="m:func">
      <xsl:element name="m:fName">
        <xsl:apply-templates select="$ndCur/child::*[1]" mode="mml2omml" />
      </xsl:element>
      <xsl:element name="m:e">
        <xsl:apply-templates select="$ndCur/child::*[3]" mode="mml2omml" />
      </xsl:element>
    </xsl:element>
  </xsl:template>
        ...
        <xsl:choose>
          ...
          <xsl:otherwise>
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                <xsl:apply-templates select="$ndCur/*" mode="mml2omml" />
              </xsl:otherwise>
            </xsl:choose>
          </xsl:otherwise>
        </xsl:choose>
  ...
  <!-- %%Template: match munder
	-->
  <xsl:template match="mml:munder" mode="mml2omml">
    <xsl:variable name="fNary">
      <xsl:call-template name="isNary">
            ...
            <xsl:choose>
              <xsl:when test="$fGroupChr=1">
                <xsl:element name="m:groupChr">
                  ...
                  <xsl:element name="m:e">
                    <xsl:apply-templates select="mml:mrow" mode="mml2omml" />
                  </xsl:element>
                </xsl:element>
              </xsl:when>
              <xsl:otherwise>
  ...
  <!-- %%Template: match mover
	-->
  <xsl:template match="mml:mover" mode="mml2omml">
    <xsl:variable name="fNary">
      <xsl:call-template name="isNary">
        <xsl:with-param name="ndCur" select="child::*[1]" />
      </xsl:call-template>
  ...
  <!-- %%Template: match munderover
	-->
  <xsl:template match="mml:munderover" mode="mml2omml">
    <xsl:variable name="fNary">
      <xsl:call-template name="isNary">
        <xsl:with-param name="ndCur" select="child::*[1]" />
      </xsl:call-template>
    ...
    <xsl:choose>
      <xsl:when test="$fNary='true'">
        <m:nary>
          ...
          <m:sup>
            <xsl:call-template name="CreateArgProp" />
            <xsl:apply-templates select="child::*[3]" mode="mml2omml" />
          </m:sup>
          <m:e>
            <xsl:call-template name="CreateArgProp" />
            <xsl:call-template name="NaryHandleMrowMstyle">
  ...
  <xsl:template match="mml:mfenced" mode="mml2omml">
    <m:d>
  ...
  <!-- %%Template: match msub
	-->
  <xsl:template match="mml:msub" mode="mml2omml">
    <xsl:variable name="fNary">
      <xsl:call-template name="isNary">
        <xsl:with-param name="ndCur" select="child::*[1]" />
      </xsl:call-template>
  ...
  <!-- %%Template: match msup
	-->
  <xsl:template match="mml:msup" mode="mml2omml">
    <xsl:variable name="fNary">
      <xsl:call-template name="isNary">
        <xsl:with-param name="ndCur" select="child::*[1]" />
      </xsl:call-template>
  ...
  <!-- %%Template: match msubsup
	-->
  <xsl:template match="mml:msubsup" mode="mml2omml">
    <xsl:variable name="fNary">
      <xsl:call-template name="isNary">
        <xsl:with-param name="ndCur" select="child::*[1]" />
      </xsl:call-template>
  ...
  <xsl:template name="SplitScripts">
    ...
    <m:sub>
      <xsl:call-template name="CreateArgProp" />
      <xsl:apply-templates select="$ndScripts[(position() mod 2) = 1]" mode="mml2omml" />
    </m:sub>
    <m:sup>
      <xsl:call-template name="CreateArgProp" />
      <xsl:apply-templates select="$ndScripts[(position() mod 2) = 0]" mode="mml2omml" />
    </m:sup>
  </xsl:template>
  ...
  <!-- %%Template: match mmultiscripts
	...
	-->
  <xsl:template match="mml:mmultiscripts" mode="mml2omml">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$cndPrescriptStrict &lt;= 0 and $cndScriptStrict &lt;= 0">
        <xsl:apply-templates select="*[1]" mode="mml2omml" />
      </xsl:when>
        ...
        <xsl:choose>
          ...
          <xsl:when test="$cndSubScript &gt; 0">
            <m:sSub>
              ...
              <m:sub>
                <xsl:apply-templates select="*[position() &gt; 1]" mode="mml2omml" />
              </m:sub>
            </m:sSub>
          </xsl:when>
          <!-- Just super script -->
            ...
            <xsl:choose>
              ...
              <xsl:when test="$cndSubScript &gt; 0">
                <m:sSub>
                  ...
                  <m:sub>
                    <xsl:apply-templates select="*[position() &gt; 1 and (position() &lt;= ($cndScript + 1))]" mode="mml2omml" />
                  </m:sub>
                </m:sSub>
              </xsl:when>
              <!-- Just super script -->
  ...
  <!-- This template transforms mtable into its appropriate omml type.
	...
	-->
  <xsl:template match="mml:mtable" mode="mml2omml">
  ...
  <xsl:template match="m:mtd" mode="mml2omml">
    <xsl:apply-templates select="*" mode="mml2omml" />
  </xsl:template>
  ...
  <xsl:template match="mml:mglyph" mode="mml2omml">
    <xsl:element name="m:r">
      <xsl:element name="m:rPr">
  ...
  <xsl:template match="mml:mi[child::mml:mglyph] | 
	                     ...
	                     mml:mtext[child::mml:mglyph]" mode="mml2omml">
  ...
  <xsl:template match="mml:mpadded" mode="mml2omml">
    <xsl:choose>
  ...
  <xsl:template match="mml:mphantom" mode="mml2omml">
    <xsl:element name="m:phant">
